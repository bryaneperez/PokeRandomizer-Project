export const FilterHolder = {
 Gen1Moves : ["Absorb","Acid","Acid Armor","Agility","Amnesia","Aurora Beam","Barrage","Barrier","Bide","Bind","Bite","Blizzard","Body Slam","Bone Club","Bonemerang","Bubble","Bubble Beam","Clamp","Comet Punch","Confuse Ray","Confusion","Constrict",
 ...
 Gen2Moves : ["Aeroblast","Ancient Power","Attract","Baton Pass","Beat Up","Belly Drum","Bone Rush","Charm","Conversion 2","Cotton Spore","Cross Chop","Crunch","Curse","Destiny Bond","Detect","Dragon Breath","Dynamic Punch","Encore",
 ...
 Gen3Moves : ["Aerial Ace","Air Cutter","Arm Thrust","Aromatherapy","Assist","Astonish","Blast Burn","Blaze Kick","Block","Bounce","Brick Break","Bulk Up","Bullet Seed","Calm Mind","Camouflage","Charge","Cosmic Power","Covet",
 ...
 Gen4Moves : ["Acupressure","Air Slash","Aqua Jet","Aqua Ring","Aqua Tail","Assurance","Attack Order","Aura Sphere","Avalanche","Brave Bird","Brine","Bug Bite","Bug Buzz","Bullet Punch","Captivate","Charge Beam","Chatter",
 ...
 Gen5Moves : ["Acid Spray","Acrobatics","After You","Ally Switch","Autotomize","Bestow","Blue Flare","Bolt Strike","Bulldoze","Chip Away","Circle Throw","Clear Smog","Coil","Cotton Guard","Dragon Tail","Drill Run","Dual Chop",
 ...
 Gen6Moves : ["Aromatic Mist","Baby-Doll Eyes","Belch","Boomburst","Celebrate","Confide","Crafty Shield","Dazzling Gleam","Diamond Storm","Disarming Voice","Dragon Ascent","Draining Kiss","Eerie Impulse","Electric Terrain",
 ...
 Gen7Moves : ["10,000,000 Volt Thunderbolt","Accelerock","Acid Downpour","All-Out Pummeling","Anchor Shot","Aurora Veil","Baddy Bad","Baneful Bunker","Beak Blast","Black Hole Eclipse","Bloom Doom","Bouncy Bubble","Breakneck Blitz",
 ...
 Gen8Moves : ["Apple Acid","Astral Barrage","Aura Wheel","Barb Barrage","Behemoth Bash","Behemoth Blade","Bitter Malice","Bleakwind Storm","Body Press","Bolt Beak","Branch Poke","Breaking Swipe","Burning Jealousy","Ceaseless Edge",
 ...
 Gen9Moves :["Alluring Voice","Aqua Cutter","Aqua Step","Armor Cannon","Axe Kick","Bitter Blade","Blazing Torque","Blood Moon","Burning Bulwark","Chilling Water","Chilly Reception","Collision Course","Combat Torque","Comeuppance",
 ...
 Gen3Abilities : ["Stench","Drizzle","Speed Boost","Battle Armor","Sturdy","Damp","Limber","Sand Veil","Static","Volt Absorb","Water Absorb","Oblivious","Cloud Nine","Compound Eyes","Insomnia","Color Change","Immunity","Flash Fire","Shield Dust",
 ...
 Gen4Abilities : ["Tangled Feet","Motor Drive","Rivalry","Steadfast","Snow Cloak","Gluttony","Anger Point","Gluttony","Anger Point","Unburden","Heatproof","Simple","Dry Skin","Download","Iron Fist","Poison Heal","Adaptability","Skill Link",
 ...
 Gen5Abilities : ["Pickpocket","Sheer Force","Contrary","Unnerve","Defiant","Defeatist","Cursed Body","Healer","Friend Guard","Weak Armor","Heavy Metal","Light Metal","Multiscale","Toxic Boost","Flare Boost","Harvest","Telepathy","Moody",
 ...
 Gen6Abilities : ["Aroma Veil","Flower Veil","Cheek Pouch","Protean","Fur Coat","Magician","Bulletproof","Competitive","Strong Jaw","Refrigerate","Sweet Veil","Stance Change","Gale Wings","Mega Launcher","Grass Pelt","Symbiosis","Tough Claws",
  "Pixilate","Gooey","Aerilate","Parental Bond","Dark Aura","Fairy Aura","Aura Break","Primordial Sea","Desolate Land","Delta Stream"],

 Gen7Abilities : ["Stamina","Wim Out","Emergency Exit","Water Compaction","Merciless","Shields Down","Stakeout","Water Bubble","Steelworker","Berserk","Slush Rush","Long Reach","Liquid Voice","Triage","Galvanize","Surge Surfer","Schooling",
 ...
 Gen8Abilities :["Intrepid Body","Dauntless Sword","Libero","Ball Fetch","Cotton Down","Propeller Tail","Mirror Armor","Gulp Missile","Stalwart","Steam Engine","Punk Rock","Sand Spit","Ice Scales","Ripen","Ice Face","Mimicry","Screen Cleaner",
 ...
 Gen9Abilities : ["Lingering Aroma","Seed Sower","Thermal Exchange","Anger Shell","Purifying Salt","Well-Baked Body","Wind Rider","Guard Dog","Rocky Payload","Wind Power","Zero to Hero","Commander","Electromorphosis","Protosynthesis","Quark Drive",
